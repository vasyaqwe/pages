...
>(
   (
      ...
      const baseClassName = cn(
         "prose prose-img:m-0 prose-p:my-2 mt-2 prose-h2:mt-0 prose-h1:mb-3 prose-h2:mb-3 min-h-9 w-full max-w-full break-words prose-p:leading-normal",
         "prose-ol:pl-4 prose-ol:pl-[1.675rem] prose-h3:font-bold prose-code:text-sm prose-h1:text-2xl prose-strong:text-foreground prose-code:before:hidden prose-code:after:hidden",
